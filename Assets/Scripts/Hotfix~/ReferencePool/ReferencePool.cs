...
namespace UGFExtensions.Hotfix
{
    ...
    {
        private static readonly IDictionary<string, ReferenceCollection> s_ReferenceCollections =
        ...
        {
            foreach (var referenceCollection in s_ReferenceCollections) referenceCollection.Value.RemoveAll();
        ...
        {
            if (reference == null) throw new GameFrameworkException("Reference is invalid.");
        ...
        {
            if (referenceType == null) throw new GameFrameworkException("Reference type is invalid.");
        ...
        {
            if (referenceType == null) throw new GameFrameworkException("ReferenceType is invalid.");
