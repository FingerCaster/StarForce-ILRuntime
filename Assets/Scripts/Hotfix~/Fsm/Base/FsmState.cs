...
namespace UGFExtensions.Hotfix
{
    ...
    public abstract class FsmState
    {
        ...
        {
            if (eventHandler == null) throw new GameFrameworkException("Event handler is invalid.");
        ...
        protected void UnsubscribeEvent(int eventId, FsmEventHandler eventHandler)
        {
            ...
            if (m_EventHandlers.ContainsKey(eventId)) m_EventHandlers[eventId] -= eventHandler;
        }
        ...
        protected void ChangeState<TState>(IFsm fsm) where TState : FsmState
        {
            ...
            if (fsmImplement == null) throw new GameFrameworkException("FSM is invalid.");
