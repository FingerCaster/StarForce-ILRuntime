...
namespace UGFExtensions.Hotfix
{
    ...
    public static class AIUtility
    {
        ...
        public static float GetDistance(EntityLogic fromEntity, EntityLogic toEntity)
        {
        ...
        public static void PerformCollision(TargetableObject entity, EntityLogic other)
        {
        ...
        private struct CampPair
        {
            ...
            {
                return (int)m_First + (int)m_Second;
            }

            public override bool Equals(object obj)
            {
                if (obj is CampPair campPair)
                {
                    return Equals(campPair);
                }
                return base.Equals(obj);
            }
            public bool Equals(CampPair campPair)
            {
                return this.First == campPair.First && this.Second == campPair.Second;
            }
        }
    }
}
