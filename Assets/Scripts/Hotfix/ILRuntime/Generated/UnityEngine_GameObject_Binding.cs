...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_GameObject_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            args = new Type[]{typeof(UGFExtensions.EntityLogicAdapter.Adapter)};
            if (genericMethods.TryGetValue("GetComponent", out lst))
            {
                foreach(var m in lst)
                {
                    if(m.MatchGenericParameters(args, typeof(UGFExtensions.EntityLogicAdapter.Adapter)))
                    {
                        method = m.MakeGenericMethod(args);
            ...
            if (genericMethods.TryGetValue("GetComponent", out lst))
            {
                foreach(var m in lst)
                {
                    if(m.MatchGenericParameters(args, typeof(UnityGameFramework.Runtime.Entity)))
                    {
                        method = m.MakeGenericMethod(args);
            ...
            args = new Type[]{typeof(global::ComponentAutoBindTool)};
            if (genericMethods.TryGetValue("GetComponent", out lst))
            {
                foreach(var m in lst)
                {
                    if(m.MatchGenericParameters(args, typeof(global::ComponentAutoBindTool)))
                    {
                        method = m.MakeGenericMethod(args);
            ...
            if (genericMethods.TryGetValue("GetComponentInParent", out lst))
            {
                foreach(var m in lst)
                {
                    ...
                    {
                        method = m.MakeGenericMethod(args);
                        app.RegisterCLRMethodRedirection(method, GetComponentInParent_16);
            ...
            app.RegisterCLRMethodRedirection(method, get_activeSelf_17);
        ...
        static StackObject* GetComponent_4(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = instance_of_this_method.GetComponent<UGFExtensions.EntityLogicAdapter.Adapter>();
        ...
        static StackObject* GetComponent_14(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = instance_of_this_method.GetComponent<UnityGameFramework.Runtime.Entity>();
        ...
        static StackObject* GetComponent_15(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = instance_of_this_method.GetComponent<global::ComponentAutoBindTool>();
        ...
        static StackObject* GetComponentInParent_16(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
            ...
            var result_of_this_method = instance_of_this_method.GetComponentInParent<UnityEngine.UI.CanvasScaler>();
        ...
        static StackObject* get_activeSelf_17(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
