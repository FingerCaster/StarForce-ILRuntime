...
{
    unsafe class System_Collections_Generic_List_1_UGFExtensions_EntityLogicAdapter_Binding_Adapter_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(System.Collections.Generic.List<UGFExtensions.EntityLogicAdapter.Adapter>);
        ...
        static StackObject* Add_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UGFExtensions.EntityLogicAdapter.Adapter @item = (UGFExtensions.EntityLogicAdapter.Adapter)typeof(UGFExtensions.EntityLogicAdapter.Adapter).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
            __intp.Free(ptr_of_this_method);

            ptr_of_this_method = ILIntepreter.Minus(__esp, 2);
            System.Collections.Generic.List<UGFExtensions.EntityLogicAdapter.Adapter> instance_of_this_method = (System.Collections.Generic.List<UGFExtensions.EntityLogicAdapter.Adapter>)typeof(System.Collections.Generic.List<UGFExtensions.EntityLogicAdapter.Adapter>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
            __intp.Free(ptr_of_this_method);
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new System.Collections.Generic.List<UGFExtensions.EntityLogicAdapter.Adapter>();
