...
namespace ILRuntime.Runtime.Generated
{
    unsafe class System_Threading_Tasks_Task_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, FromException_0);


        }


        static StackObject* FromException_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = System.Threading.Tasks.Task.FromException(@exception);
