    ...
    unsafe class UGFExtensions_Await_AwaitableExtension_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            if (genericMethods.TryGetValue("LoadAssetAsync", out lst))
            {
                ...
                {
                    if(m.MatchGenericParameters(args, typeof(System.Threading.Tasks.Task<UnityEngine.GameObject>), typeof(UnityGameFramework.Runtime.ResourceComponent), typeof(System.String)))
                    {
        ...
        static StackObject* LoadHotfixDataTableAsync_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = UGFExtensions.Await.AwaitableExtension.LoadHotfixDataTableAsync(@dataTableComponent, @dataTableName, @dataTableAssetName, @userData);
        ...
        static StackObject* OpenUIFormAsync_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = UGFExtensions.Await.AwaitableExtension.OpenUIFormAsync(@uiComponent, @uiFormId, @userData);
        ...
        static StackObject* ShowEntityAsync_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = UGFExtensions.Await.AwaitableExtension.ShowEntityAsync(@entityComponent, @entityId, @entityLogicType, @entityAssetName, @entityGroupName, @priority, @userData);
