...
{
    unsafe class UGFExtensions_LoadHotfixDataTableUserData_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(UGFExtensions.LoadHotfixDataTableUserData);
            args = new Type[]{};
        ...
        static StackObject* get_UserData_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UGFExtensions.LoadHotfixDataTableUserData instance_of_this_method = (UGFExtensions.LoadHotfixDataTableUserData)typeof(UGFExtensions.LoadHotfixDataTableUserData).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new UGFExtensions.LoadHotfixDataTableUserData(@dataTableName, @userData);
