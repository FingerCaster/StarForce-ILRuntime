...
//will auto register in unity
        ...
        public static void Initialize(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            UGFExtensions_TimingWheelComponent_Binding.Register(app);
            ET_ETTask_Binding.Register(app);
            System_TimeSpan_Binding.Register(app);
            TimingWheel_Extensions_DateTimeHelper_Binding.Register(app);
            UGFExtensions_LoopTask_Binding.Register(app);
