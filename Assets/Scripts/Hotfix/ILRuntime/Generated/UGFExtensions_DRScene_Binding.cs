...
{
    unsafe class UGFExtensions_DRScene_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(UGFExtensions.DRScene);
            args = new Type[]{};
        ...
        static StackObject* get_AssetName_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UGFExtensions.DRScene instance_of_this_method = (UGFExtensions.DRScene)typeof(UGFExtensions.DRScene).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
