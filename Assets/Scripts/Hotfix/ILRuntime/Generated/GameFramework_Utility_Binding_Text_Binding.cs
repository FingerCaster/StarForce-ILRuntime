    ...
    unsafe class GameFramework_Utility_Binding_Text_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            if (genericMethods.TryGetValue("Format", out lst))
            {
                foreach(var m in lst)
                {
                    if(m.MatchGenericParameters(args, typeof(System.String), typeof(System.String), typeof(System.String), typeof(System.String)))
                    {
                        method = m.MakeGenericMethod(args);
        ...
        static StackObject* Format_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = GameFramework.Utility.Text.Format<System.String>(@format, @arg);
        ...
        static StackObject* Format_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = GameFramework.Utility.Text.Format<System.String, System.String>(@format, @arg1, @arg2);
