...
{
    unsafe class UGFExtensions_EntityExtensions_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(UGFExtensions.EntityExtensions);
        ...
        static StackObject* GenerateSerialId_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = UGFExtensions.EntityExtensions.GenerateSerialId(@entityComponent);
