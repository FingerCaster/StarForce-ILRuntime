...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityGameFramework_Runtime_SoundComponent_Binding
    {
        ...
        static StackObject* StopAllLoadingSounds_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityGameFramework.Runtime.SoundComponent instance_of_this_method = (UnityGameFramework.Runtime.SoundComponent)typeof(UnityGameFramework.Runtime.SoundComponent).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
