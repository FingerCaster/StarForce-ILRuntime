...
namespace ILRuntime.Runtime.Generated
{
    unsafe class System_Runtime_CompilerServices_AsyncVoidMethodBuilder_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            args = new Type[]{typeof(System.Runtime.CompilerServices.TaskAwaiter<System.Boolean>), typeof(UGFExtensions.Hotfix.IAsyncStateMachineAdaptor.Adaptor)};
            if (genericMethods.TryGetValue("AwaitUnsafeOnCompleted", out lst))
            {
                foreach(var m in lst)
                {
                    if(m.MatchGenericParameters(args, typeof(void), typeof(System.Runtime.CompilerServices.TaskAwaiter<System.Boolean>).MakeByRefType(), typeof(UGFExtensions.Hotfix.IAsyncStateMachineAdaptor.Adaptor).MakeByRefType()))
                    {
                        method = m.MakeGenericMethod(args);
        ...
        static StackObject* AwaitUnsafeOnCompleted_5(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            instance_of_this_method.AwaitUnsafeOnCompleted<System.Runtime.CompilerServices.TaskAwaiter<System.Boolean>, UGFExtensions.Hotfix.IAsyncStateMachineAdaptor.Adaptor>(ref @awaiter, ref @stateMachine);
