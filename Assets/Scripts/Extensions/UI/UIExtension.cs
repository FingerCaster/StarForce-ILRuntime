...
namespace UGFExtensions
{
    public  static partial class UIExtension
    {
        ...
        {
            DRUIForm drUIForm =  GameEntry.DataTableExtension.GetDataRow<DRUIForm>(uiFormId);
            if (drUIForm == null)
            {
                return false;
            }
        ...
        {
            DRUIForm drUIForm = GameEntry.DataTableExtension.GetDataRow<DRUIForm>(data => AssetUtility.GetUIFormAsset(data.AssetName) == uiForm.UIForm.UIFormAssetName);
            if (drUIForm == null)
            {
