...
namespace UGFExtensions
{
    public static class SoundExtension
    {
        ...
        public static int? PlayMusic(this SoundComponent soundComponent, int musicId, object userData = null)
        {
            ...
            DRMusic drMusic = GameEntry.DataTableExtension.GetDataRow<DRMusic>(musicId);
            if (drMusic == null)
            {
        ...
        {
            DRSound drSound = GameEntry.DataTableExtension.GetDataRow<DRSound>(soundId);
            if (drSound == null)
            {
        ...
        {
            DRUISound drUISound = GameEntry.DataTableExtension.GetDataRow<DRUISound>(uiSoundId);
            if (drUISound == null)
            {
